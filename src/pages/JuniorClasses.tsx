...
const JuniorClasses: React.FC = () => {
    ...
    return (
        <div className="page-container">
            ...
            <div className="junior-main-container">
                {/* Sidebar */}
                <aside className="junior-sidebar">
                    <img src={ProgressionChart} alt="Progression Chart" className="progression-chart-img" />
                    <div className="sidebar-nav-container">
                        <button onClick={() => scrollToSection('little-aces')} className="sidebar-nav-btn">Little Aces</button>
                        <button onClick={() => scrollToSection('red-ball')} className="sidebar-nav-btn">Red</button>
                        <button onClick={() => scrollToSection('orange-ball')} className="sidebar-nav-btn">Orange</button>
                        <button onClick={() => scrollToSection('intro-orange')} className="sidebar-nav-btn">Intro Orange</button>
                        <button onClick={() => scrollToSection('green-ball')} className="sidebar-nav-btn">Green</button>
                        <button onClick={() => scrollToSection('yellow-ball')} className="sidebar-nav-btn">Yellow</button>
                        <button onClick={() => scrollToSection('teen-green')} className="sidebar-nav-btn">Teen Green</button>
                        <button onClick={() => scrollToSection('high-school')} className="sidebar-nav-btn">High School</button>
                        <button onClick={() => scrollToSection('tournament-pathway')} className="sidebar-nav-btn">Tournament</button>
                    </div>
                </aside>

                {/* Main Content */}
                <div className="junior-content-area">
                    {/* Little Aces */}
                    <section className="junior-section bg-white">
                        <div className="junior-content-container">
                            <div className="junior-text-column">
                                <h2 id="little-aces" className="junior-section-title">Little Aces</h2>
                            ...
                            <div className="junior-media-column">
                    ...
                    <section className="junior-section bg-white">
                        <div className="junior-content-container">
                            <div className="junior-text-column">
                                <h2 id="red-ball" className="junior-section-title">Red Ball</h2>
                                <div className="junior-section-text">
                    ...
                    {/* Orange Ball */}
                    <section className="junior-section bg-gray">
                        <div className="junior-content-container">
                            <div className="junior-text-column">
                                <h2 id="orange-ball" className="junior-section-title">Orange Ball</h2>
                                <div className="junior-section-text">
                    ...
                    {/* Intro Orange */}
                    <section className="junior-section bg-white">
                        <div className="junior-content-container text-only">
                            <h2 id="intro-orange" className="junior-section-title">Intro Orange</h2>
                            <div className="junior-section-text">
                                <p>The Intro Orange class is one of our final pieces for the junior program. It fills the gap for our 11 and 12 year olds that are relatively new to the sport. The group takes place on a smaller court with lower compression balls, that are great for introductory work on the skills needed to progress. The slower balls allow more time for players to adjust and work on techniques and tactics.</p>
                    ...
                    <section className="junior-section bg-gray">
                        <div className="junior-content-container">
                            <div className="junior-text-column">
                                <h2 id="green-ball" className="junior-section-title">Green Ball</h2>
                                <div className="junior-section-text">
                    ...
                    <section className="junior-section bg-white">
                        <div className="junior-content-container text-only">
                            <h2 id="yellow-ball" className="junior-section-title">Yellow Ball</h2>
                            <div className="junior-section-text">
                    ...
                    <section className="junior-section bg-gray">
                        <div className="junior-content-container text-only">
                            <h2 id="teen-green" className="junior-section-title">Teen Green</h2>
                            <div className="junior-section-text">
                    ...
                    <section className="junior-section bg-white">
                        <div className="junior-content-container text-only">
                            <h2 id="high-school" className="junior-section-title">High School (Challenger)</h2>
                            <div className="junior-section-text">
                    ...
                    {/* Tournament Pathway */}
                    <section className="junior-section bg-gray">
                        <div className="junior-content-container column-layout">
                            <div className="junior-text-column">
                                <h2 id="tournament-pathway" className="junior-section-title">Tournament Pathway</h2>
                                <div className="junior-section-text">
